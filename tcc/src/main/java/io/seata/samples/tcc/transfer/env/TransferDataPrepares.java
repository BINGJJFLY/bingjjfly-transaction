...
public class TransferDataPrepares {
    ...
    protected void prepareTable(DataSource dataSource){
        ...
        try {
            ...
            s.execute("CREATE TABLE  business_activity  ( tx_id  varchar(128) NOT NULL , gmt_create  TIMESTAMP , gmt_modified  TIMESTAMP , instance_id  varchar(128)  , business_type  varchar(32) , business_id  varchar(128)  , state  varchar(2) , app_name  varchar(32) ,  timeout  int(11) ,  context  varchar(2000) , is_sync  varchar(1) , PRIMARY KEY ( tx_id )) ");
            ...
            s.execute("CREATE TABLE  business_action  (  tx_id  varchar(128) , action_id  varchar(64)  , gmt_create  TIMESTAMP  , gmt_modified  TIMESTAMP , instance_id  varchar(128)  , rs_id  varchar(128) , rs_desc  varchar(512) , rs_type  smallint(6)  , state  varchar(2) , context  varchar(2000) , PRIMARY KEY ( action_id ))");
            ...
            s.execute("create table account(account_no varchar(128), amount DOUBLE,  freezed_amount DOUBLE, PRIMARY KEY (account_no))");
